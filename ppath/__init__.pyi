...
class CalledProcessError(SubprocessError):
    ...
    process: Optional[CompletedProcess]
    def __init__(self, returncode: int, cmd: Union[StrOrBytesPath, Sequence[StrOrBytesPath]],
                 output: Optional[AnyStr] = ..., stderr: Optional[AnyStr] = ...) -> None: ...
subprocess.CalledProcessError = SubprocessError
...
PathStat = NamedTuple('PathStat', gid=int, group=str, mode=str, result=os.stat_result, root=bool, sgid=bool,
                      sticky=bool, suid=bool, uid=int, user=str)
@dataclass
class Passwd:
